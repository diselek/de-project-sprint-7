...
## /usr/lib/spark/bin/spark-submit --master yarn --deploy-mode cluster initial_load_job.py shevet hdfs://rc1a-dataproc-m-dg5lgqqm7jju58f9.mdb.yandexcloud.net:8020 /user/master/data/geo/events/
## spark-submit --master yarn --deploy-mode cluster initial_load_job.py sname hdfs_path geo_path

args = {
    "owner": "shevet",
    'email': ['brok01@yandex.ru'],
...
with DAG(
        ...
        default_args=args,
        description='start spark for migration data',
        catchup=False,
