...
## /usr/lib/spark/bin/spark-submit --master yarn --deploy-mode cluster calculating_geo_analitics.py shevet hdfs://rc1a-dataproc-m-dg5lgqqm7jju58f9.mdb.yandexcloud.net:8020 /user/master/data/geo/events/ 2022-05-21 28
